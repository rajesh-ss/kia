export const HomeWrapper = () => {
  return (
    <div className=" w-[100vw] h-[calc(100vh-4rem)] flex justify-center items-center bg-[#00000094]">
      <div className="border-[0rem] border-[#fff] mt-[2rem] flex flex-col justify-center items-center gap-2  p-5">
        <svg
          version="1.0"
...
-52 60 c-29 34 -58 61 -63 61 -6 0 -34 25 -63 55 -62 64 -99 73 -116 29z"
        ...
        <h1 className="text-[#fff] text-[3rem] font-[800]">SKIA COFFEE</h1>
        <h2 className="text-[#fff] text-[2rem] font-[600]">
          IT ALL{" "}
          <span className="text-[#fff] text-[2.8rem] font-[900]">BEGINS</span>
        </h2>
        <h2 className="text-[#fff] text-[2rem] font-[600]">
          AT{" "}
          <span className="text-[#fff] text-[2.8rem] font-[900]">THE FARM</span>
        </h2>
      </div>
    </div>
  );
